...
const ProductDetails = async ({ params: {id} }: Props) => {
    var numberOfBuyers = Math.floor(Math.random()* 16) + 85
    var numberOfStars = Math.floor(Math.random()* 51) + 51
                    ...
                    <div className='product-info'>
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <p className='text-sm text-black opacity-50'>
                                <span className='text-primary-green font-semibold'>{numberOfBuyers}%</span> of buyers have recommended this product
                            </p>
                        </div>
                    </div>
